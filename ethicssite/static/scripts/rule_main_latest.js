$(document).ready(() => {
  ...
  $('.add_rules_card').on('click', event => {
    var structure = $('<div class = "rule_card card"><label>Rule name:</label><input type="text" name="rule_name" id="attribute_name" placeholder="Rule name"><br><label>Rule type:</label><input type="text" name="rule_set" id="attribute_type" placeholder="Rule type"></div>');
